...
typedef int    (* platform_set_acs_exclusion_list_t)(unsigned int radioIndex, hash_map_t *radiomap);
...
INT wifi_hal_set_acs_exclusion_list(hash_map_t *radio_map, int radioIndex);
...
int wifi_drv_set_acs_exclusion_list(unsigned int radioIndex, hash_map_t *radiomap);
