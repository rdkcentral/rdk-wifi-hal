...
static void nl80211_frame_tx_status_event(wifi_interface_info_t *interface, struct nlattr **tb)
{
    ...
    wifi_frame_t mgmt_frame;
    int sig_dbm = -100;
#if  (defined(TCXB7_PORT) || defined(CMXB7_PORT) || defined(TCXB8_PORT) || defined(XB10_PORT) || defined (TCHCBRV2_PORT) || defined(SCXER10_PORT) || defined(VNTXER5_PORT) || defined (TARGET_GEMINI7_2) || defined(RDKB_ONE_WIFI_PROD))
    int phy_rate = 60;
#endif
...
#if  (defined(TCXB7_PORT) || defined(CMXB7_PORT) || defined(TCXB8_PORT) || defined(XB10_PORT) || defined(SCXER10_PORT) || defined (TCHCBRV2_PORT) || defined(VNTXER5_PORT) || defined (TARGET_GEMINI7_2) || defined(RDKB_ONE_WIFI_PROD))
   ...
   if (event.tx_status.type  == WLAN_FC_TYPE_MGMT &&
     (event.tx_status.stype == WLAN_FC_STYPE_AUTH ||
        ...
        if (callbacks->mgmt_frame_rx_callback && mgmt_type != WIFI_MGMT_FRAME_TYPE_ACTION) {
            ...
            callbacks->mgmt_frame_rx_callback(vap->vap_index, &mgmt_frame);
#else
#if defined(RDK_ONEWIFI) && (defined(TCXB7_PORT) || defined(CMXB7_PORT) || defined(TCXB8_PORT) || defined(XB10_PORT) || defined(SCXER10_PORT) || defined (TCHCBRV2_PORT) || defined(VNTXER5_PORT) || defined (TARGET_GEMINI7_2) || defined(RDKB_ONE_WIFI_PROD))
