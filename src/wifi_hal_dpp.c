...
base64urldecode (unsigned char *data, unsigned char *burl, int len)
{
    ...
    /* CID: 559602: Overflowed integer argument fix */
    ...
    /* CID: 340791: Out-of-bounds access fix */
    if (res == -1) {
        free(b64);
        free(unb64);
        return -1;
      ...
      unsigned char *okm, int okmlen)
{
    ...
    /* CID: 340805: Out-of-bounds access fix */
